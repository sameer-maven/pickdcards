...
@section('content')
<!-- support-sec -->
<div class="support-sec sec-padding overlay1 business-support topbanner-padd default-banner" style="background-image: url({{ asset('front/assets/images/page-banner.jpg') }});">
   <div class="container">
      <div class="row">
         <div class="col-lg-6">
