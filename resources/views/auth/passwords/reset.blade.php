      ...
      <div class="wrap-contact">
        ...
        <form class="mt-4" method="POST" action="{{ route('password.update') }}" id="reset-final-form">
            ...
            <div class="form-group">
               ...
               <input id="password" placeholder="{{ __('Password') }}" type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" required autocomplete="new-password">
            ...
            <button type="submit" class="btn btn-primary reset-btn">{{ __('Reset Password') }}</button>
         </form>
      </div>
   </div>
</div>
...
<script>
    $(document).ready(function(){
        $(".reset-btn").click(function(e){
            ...
            $('#reset-final-form').validate({ // initialize the plugin
                rules: {
                    email: {
                        required: true,
                        email: true
