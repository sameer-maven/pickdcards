    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" id="adminPageFrm" method="POST" action="{{ url('admin/pages/'.$data->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="slug" placeholder="Enter Slug / URL" value="{{$data->slug}}">
              </div>
              <div class="form-group">
